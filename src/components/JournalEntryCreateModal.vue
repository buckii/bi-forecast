    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg max-w-3xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div v-else>
          ...
          <div class="mb-6">
            ...
            <div class="grid grid-cols-2 gap-4">
              ...
              >
                ...
                <div class="text-sm text-gray-500 dark:text-gray-400 mt-1">Distribute invoice over multiple months</div>
              </button>
            </div>
          </div>
          ...
          <div class="space-y-4">
            <div>
              ...
              <input type="text" v-model="form.clientName" class="input" placeholder="e.g., ACE" />
            </div>

            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"> Invoice Number </label>
              <input type="text" v-model="form.invoiceNumber" class="input" placeholder="e.g., 125768" />
            </div>
            ...
            <template v-if="mode === 'shift'">
              <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input type="date" v-model="form.workDate" class="input" />
            ...
            <template v-if="mode === 'spread'">
              ...
              <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input type="date" v-model="form.recognitionStartDate" class="input" />
                </div>
              </div>
            ...
            <div>
              ...
              <select v-model="form.revenueAccountId" class="input">
                ...
                <option v-for="account in revenueAccounts" :key="account.value" :value="account.value">
            ...
            <div>
              ...
              <select v-model="form.unearnedRevenueAccountId" class="input">
                ...
                <option v-for="account in unearnedAccounts" :key="account.value" :value="account.value">
                  {{ account.fullyQualifiedName }} (#{{ account.value }})
                </option>
              </select>
            </div>
      ...
      <div class="flex items-center justify-between p-6 border-t dark:border-gray-700">
        ...
        <div class="flex space-x-3">
          <button v-if="showPreview" @click="showPreview = false" class="btn-secondary">← Back to Form</button>
          <button v-else @click="$emit('close')" class="btn-secondary">Cancel</button>
          <button
            v-if="showPreview"
            @click="createEntries"
            :disabled="creating"
          ...
          <button v-else @click="showPreviewMode" :disabled="!isFormValid" class="btn-primary">
            Preview Entries →
          </button>
        </div>
      </div>
