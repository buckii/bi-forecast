<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    >
      <div
        class="flex items-center h-16 bg-primary-600 transition-all duration-300"
      ...
      <nav class="mt-8 flex flex-col gap-2">
        ...
        >
          ...
          >
            ...
            />
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h3m5 0h3M7 12h10M7 16h10" />
          </svg>
      ...
      <!-- User info -->
      <div
        class="absolute bottom-0 w-full p-4 border-t dark:border-gray-700 bg-white dark:bg-gray-800 transition-all duration-300"
      ...
      >
        <div class="flex items-center" :class="sidebarCollapsed ? 'justify-center' : ''">
          ...
          <div v-if="!sidebarCollapsed" class="flex-1 min-w-0 transition-opacity duration-300">
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 truncate" :title="user?.email">
