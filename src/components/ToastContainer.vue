  ...
  <div class="fixed top-4 right-4 z-50 space-y-2 pointer-events-none">
    <transition-group name="toast">
      ...
      >
        ...
        <!-- Close button -->
        <button @click="remove(toast.id)" class="flex-shrink-0 hover:opacity-75 transition-opacity">
...
function toastClasses(type) {
  const classes = {
    ...
    warning:
      'bg-yellow-50 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-100 border border-yellow-200 dark:border-yellow-700',
